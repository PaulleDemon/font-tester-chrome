...
function loadEffects(data) {
    ...
    data.forEach((x) => {
        let template = `
            <div class="tw-w-[450px] tw-h-[400px] tw-p-2 tw-rounded-md tw-overflow-hidden
                ...
                <div class="tw-flex tw-min-h-[50px] tw-h-[100px] tw-w-full tw-justify-between tw-place-content-center tw-place-items-center" >
                    <h2 class="tw-text-xl tw-font-medium">${x.title}</h2>
